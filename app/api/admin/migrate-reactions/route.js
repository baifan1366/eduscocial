...
/**
 * POST handler for running reactions table migration
 */
export async function POST(request) {
  try {
    ...
    console.log('[POST /api/admin/migrate-reactions] Starting reactions migration...');

    // Since we can't run DDL through Supabase client, we'll provide the SQL
    const migrationSQL = `
...
`;
    ...
    console.error('[POST /api/admin/migrate-reactions] Unexpected error:', error);
    return NextResponse.json(
