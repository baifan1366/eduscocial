...
const queryKeys = {
  ...
  users: {
    ...
    settings: () => [...queryKeys.users.all, 'settings']
  },
  ...
  creditPlans: {
    all: ['creditPlans'],
    lists: () => [...queryKeys.creditPlans.all, 'list'],
    list: (filters) => [...queryKeys.creditPlans.lists(), filters],
    details: () => [...queryKeys.creditPlans.all, 'detail'],
    detail: (id) => [...queryKeys.creditPlans.details(), id],
},
  ...
  payments: {
    ...
    paymentMethods: () => [...queryKeys.payments.all, 'paymentMethods'],
    paymentIntent: (id) => [...queryKeys.payments.all, 'paymentIntent', id],
    checkoutSession: (id) => [...queryKeys.payments.all, 'checkoutSession', id]
  },
  ...
  creditOrders: {
    ...
    create: () => [...queryKeys.creditOrders.all, 'create']
  },
